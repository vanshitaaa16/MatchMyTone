    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.headerTitle}>Body Shape Quiz</Text>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            onPress={() => router.replace("/BodyShapeQuizNew")}
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: "700", color: "#2C2C2C", flex: 1, textAlign: "center" },
